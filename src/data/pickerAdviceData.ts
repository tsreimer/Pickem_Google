...
export const INDIVIDUAL_PICKERS_ADVICE: PickerAdviceProfile[] = [
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[slaps laminate counter, points beef tongs with conviction]',
      script:
        "Hey Todd! Coach Sal comin' to ya from Vito & Sal's Beef on 35th and Halsted! Listen to me very carefully: do NOT look at dat 8th place rank and get discouraged! Droppin' 9 points on da Rams was a superficial flesh wound! You know why? Because you didn't burn your heavy artillery! Your top seven anchors are still 100% alive: sixteen on da Chargers, fifteen on da Jags, fourteen on Detroit! You got 91 points locked on heavy favorites while dese other knuckleheads burned their 15s and 16s at SoFi! Stay disciplined, ride dem heavy favorites on Sunday, don't shuffle your lineup, and by Monday night you're takin' home da Initech crown! Now eat a combo dipped wit' hot giardiniera and let's go!",
      tacticalPointers: [
    ...
    commishAdvice: {
      ...
      stageDirections: '[automated league terminal ping, mechanical chime]',
      script:
        "Initech Invitational Official Directive for Team 'CramItUp Your CramHole Lafleur': Official pool records indicate Todd Reimer holds a 127 maximum possible score. Only PatN holds a higher ceiling, but Todd's distribution is weighted 3.4x more heavily on heavy favorites. Verdict: High probability of taking 1st place by Sunday 7:30 PM.",
      tacticalPointers: [
        'Ceiling: 127 points.',
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[scoffs with admiration, pours a fresh Old Style draft]',
      script:
        "Orange crush! Twenty-six points in da bank! You hit dat Niners upset when eleven other guys drove their trucks off a cliff at SoFi! Hats off to ya! But listen to Coach Sal: Sunday is where championship seasons get won or lost. You already cashed your 16-point anchor on Seattle and your 10 on San Fran. That means you got fewer heavy bullets left for Sunday afternoon. Do NOT get cute! Don't start gamblin' on weird underdogs just because Shanahan made ya look like Nostradamus! Play your chalk, protect your lead, and don't give Todd room to breathe!",
      tacticalPointers: [
    ...
    chloeAdvice: {
      ...
      stageDirections: '[analyzes variance decay curve, dry chuckle]',
      script:
        "Orange crush, you pulled off an 8.3% probability hit with that San Francisco upset. Enjoy the 18-point cushion, but mathematically, your variance profile has peaked early. Having spent your 16-point anchor on Seattle, your average remaining confidence weight across the 14 games is 7.8 points. If the heavy favorites sweep Sunday, your lead will shrink by 4.2 points per window. Lock down conservative chalk.",
      tacticalPointers: [
    ...
    commishAdvice: {
      ...
      stageDirections: '[siren tone, alert flashing orange]',
      script:
        "Alert to Orange crush: You are currently the sole manager in Yahoo #13003 with zero lost confidence points. Historical league records show Week 1 Day 1 leaders who spent their top anchor early surrender the lead 62% of the time by Sunday Night Football.",
      tacticalPointers: [
        'Points Banked: 26.',
        'Remaining Max: 136.',
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[clutches chest in theatrical agony, wipes brow wit grease rag]',
      script:
        "Shoeman... marone, my stomach hurts just lookin' at your scorecard! Sixteen points on da Rams?! Ya put your absolute number one maximum anchor on an offense dat couldn't punch it in from da two-yard line! Dat sixteen-point bonfire chops your season ceiling down to 120 points on game number two! You are currently sittin' in 2nd place on paper, but dat's fool's gold! Here's your only survival advice: you CANNOT play chalk on Sunday! If everyone else hits their 14s and 15s, you're dead in da water! You gotta hunt two live underdogs, hammer 'em, and pray for total Sunday afternoon anarchy!",
      tacticalPointers: [
    ...
    chloeAdvice: {
      ...
      stageDirections: '[shakes head solemnly, brings up mortality regression]',
      script:
        "Shoeman, that 16-point allocation to Los Angeles was a catastrophic expected value miscalculation. With 120 maximum remaining points, you have zero margin for error. A standard conservative strategy yields an expected 98.4 total points, which historically finishes 8th or lower in Group 13003. Your only mathematical path to a podium payout is asymmetric leverage—you must embrace positive-skew underdogs on Sunday.",
      tacticalPointers: [
    ...
    commishAdvice: {
      ...
      stageDirections: '[red alert klaxon, skull icon display]',
      script:
        "Carnage confirmed: Shoeman holds the lowest maximum ceiling (120) of all 12 teams in the Initech Invitational. Recovery requires immediate high-risk strategy shift.",
  ...
  },
  {
    ...
    commishAdvice: {
      ...
      stageDirections: '[gold badge chime, green shield icon]',
      script:
        "Initech Award: BroncosCountry (PatN) has been awarded the 'Steel Armor' badge for absorbing the lowest net loss in the SoFi Rams massacre.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[shouts into microphone, holds up giant clown nose]',
      script:
        "Niner Faithful! What in da name of Mike Singletary is goin' on in your head, kid?! You got 'Niner' right in your team name, you probably got a Joe Montana jersey in your closet, and you put ELEVEN points on da Rams against your own team?! You watched San Francisco win, and instead of crackin' a cold one, you lost eleven confidence points! Dat is a certified South-Side clown performance! Here's your therapy advice: on Sunday, stop outthinkin' yourself! Pick wit' your heart or pick wit' the numbers, but never betray your squad like dat again! You got 125 points left—clean it up!",
      tacticalPointers: [
    ...
    commishAdvice: {
      ...
      stageDirections: '[clown horn sound effect, blinking red citation]',
      script:
        "Citation issued to Niner Faithful: Betraying your namesake franchise in Week 1 resulted in an 11-point forfeiture. Pool sentiment ranks this as the funniest moment of Day 1.",
  ...
  },
  {
    ...
    chloeAdvice: {
      ...
      stageDirections: '[adjusts glasses, charts remaining distribution]',
      script:
        "Sir Limps-A-Lot sacrificed 13 leverage points on Los Angeles, restricting maximum ceiling to 123. To reach a top-3 podium finish, you must achieve a 92.8% hit rate across the remaining 14 games. Zero room for low-confidence flyers.",
      tacticalPointers: ['Loss: -13 pts.', 'Ceiling: 123 pts.', 'Target: Conservative chalk sweep.'],
    },
    commishAdvice: {
      title: "Commish AI Status for Sir Limps-A-Lot",
      headline: "Danger Zone: Rank 11 in Group #13003",
      stageDirections: '[yellow warning blinker]',
      script:
        "Status Alert: Sir Limps-A-Lot holds 6 points, trailing leader Orange crush by 20 points. High dependency on Sunday 1:00 PM slate.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[grabs telephone receiver, Ditka scowl]',
      script:
        "markk! Losing 13 points on Los Angeles hurts like an unblocked blindside sack! You're tied for last place right now wit' 6 points. But it's Week 1, pal! Fourteen games is a whole lifetime in football! Don't throw in da towel. Lean on your double-digit home favorites on Sunday and crawl your way out of da cellar!",
      tacticalPointers: [
    ...
    chloeAdvice: {
      ...
      stageDirections: '[reviews regression line, crisp voice]',
      script:
        "markk, 13 points lost on LAR drops your ceiling to 123. Statistically, trailing by 20 points after two games is intimidating, but 84% of total pool points remain unearned. Stick to probability-weighted consensus.",
    ...
    commishAdvice: {
      ...
      stageDirections: '[warning pulse]',
      script: "markk is currently ranked 12th of 12 teams. Immediate turnaround required on Sunday.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[chuckles warmly, wipes counter]',
      script:
        "3-D, you banked 13 big ones on Seattle! That's good football! But that 12-point ding on the Rams kept you from takin' over first place! You're in 3rd right now, which looks pretty on paper, but Todd Reimer is lurkin' in the weeds with all his heavy anchors ready to pounce! Keep your guards up!",
      tacticalPointers: [
    ...
    chloeAdvice: {
      ...
      stageDirections: '[charts rank transition matrix]',
      script:
        "3-D holds 13 points, but losing 12 points limits your ceiling to 124. Both Todd (127) and PatN (135) have higher maximum upside. You must avoid any further upsets on Sunday.",
    ...
    commishAdvice: {
      ...
      stageDirections: '[amber status]',
      script: "3-D holds the bronze position. Projected drop if Todd sweeps Sunday afternoon.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[slaps table, shakes finger playfully]',
      script:
        "Snap Judgments! 12 points in da bank puts you in 4th place. Losing 11 on the Rams hurts, but you're right in the thick of the fight. Don't go makin' wild snap judgments on Sunday morning! Trust your big confidence locks, run between the tackles, and stay in contention!",
      tacticalPointers: [
    ...
    chloeAdvice: {
      ...
      stageDirections: '[taps tablet screen]',
      script:
        "Snap Judgments sits at rank 4 with 12 points. An 11-point loss is within manageable standard error. Maintain discipline on heavy favorites.",
    ...
    commishAdvice: {
      ...
      stageDirections: '[green/amber indicator]',
      script: "Snap Judgments is 4th in Group 13003 with 12 points.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[Ditka scowl, folds arms]',
      script:
        "Torts! You lost 12 on the Rams, but you cashed 11 on Seattle. You're in 5th place right in the middle of the pack. Keep your defense tight on Sunday. Push the pile, protect your 13 and 14 picks, and watch the guys ahead of you stumble!",
    ...
    chloeAdvice: {
      ...
      stageDirections: '[nods thoughtfully]',
      script:
        "Torts Illustrated holds 11 points at rank 5. Standard regression suggests sticking with high-probability home favorites on Sunday.",
      tacticalPointers: ['Rank: 5.', 'Loss: -12 pts.', 'Ceiling: 124 pts.'],
    },
    commishAdvice: {
      title: "Commish AI Note for Torts Illustrated",
      headline: "Mid-Pack Status in Group 13003",
      stageDirections: '[status ok]',
      script: "Torts Illustrated: 11 points banked, 124 max possible points.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[slaps table with vigor]',
      script:
        "BigD! Ten points in the bank, 12 points burned on the Rams. Sunday is gut-check time, pal! Lean on Detroit and Philadelphia to stop the bleeding. Play tough trench football and climb back into the top three!",
    ...
    chloeAdvice: {
      ...
      stageDirections: '[analyzes win prob]',
      script:
        "BigD holds 10 points. Avoid secondary upset gambits until Sunday afternoon variance materializes.",
      tacticalPointers: ['Loss: -12 pts.', 'Ceiling: 124 pts.'],
    },
    commishAdvice: {
      title: "Commish AI Summary for BigD",
      headline: "Rank 6 Notice",
      stageDirections: '[neutral beep]',
      script: "BigD sits in 6th place with 10 points.",
  ...
  },
  {
    ...
    salAdvice: {
      ...
      stageDirections: '[chuckles in Ditka baritone]',
      script:
        "Bird Boss, you only cashed 6 on Seattle and lost 10 on the Rams. You're in 10th place right now, but 14 games is plenty of time to take flight! Fire up your remaining anchors on Sunday and climb back into the top half of Group 13003!",
    ...
    chloeAdvice: {
      ...
      stageDirections: '[points out upside divergence]',
      script:
        "Bird Boss holds 6 points, but with only 10 points lost, your ceiling of 126 is superior to 3rd place 3-D (124). High upside if you sweep Sunday.",
      tacticalPointers: ['Ceiling: 126 pts.', 'Rank: 10.'],
    },
    commishAdvice: {
      title: "Commish AI Note for Bird Boss",
      headline: "Sleeping Upside Alert: 126 Max Points",
      stageDirections: '[blue alert chime]',
      script: "Bird Boss retains a 126 maximum point ceiling despite 10th place rank.",
